...
const GraphKidney: React.FC<GraphProps> = ({ data, label }) => {
    ...
    useEffect(() => {
        ...
        const updatedData = {
            ...
            datasets: [
                {
                    label: "Vertical", // Dataset label for refIVDScore
                ...
                {
                    label: 'Horizontal', // Dataset label for ref1hrs
                ...
                {
                    label: 'Thickness', // Dataset label for ref2hrs
