...
const EchogenicityPrev: React.FC<GraphValuesProps> = ({
    label,
    onEdit,
    // SubmitActive,
}) => {
                        ...
                        >
                            ...
                            >
                                ...
                                <Dropdown
                                    ...
                                    options={[{ label: "Homogenous and Normal" }, { label: "Increased - Right" }, { label: "Increased - Left" }, { label: "Increased - Both" }]}
...
export default EchogenicityPrev;