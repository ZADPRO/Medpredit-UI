...
const CorticoPrev: React.FC<GraphValuesProps> = ({
    label,
    onEdit,
}) => {
    ...
    const addItem = () => {
        const allFieldsFilled = data.every(
            (item) => item.date !== null && item.number !== null && item.oneHour !== null
        );

        if (allFieldsFilled) {
            setData([...data, { id: null, date: null, number: null, oneHour: null, flag: "ui" }]);
        }
    };
                        ...
                        >
                            ...
                            >
                                ...
                                <Dropdown
                                    ...
                                    options={[{ label: "Well Differentiated" }, { label: "Distorted - Right" }, { label: "Distorted - Left" }, { label: "Distorted - Both" }, { label: "Poorly Differentiated - Right" }, { label: "Poorly Differentiated - Left" }, { label: "Poorly Differentiated - Both" }]}
