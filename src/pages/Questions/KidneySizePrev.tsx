...
const KidneySizePrev: React.FC<GraphValuesProps> = ({
    label,
    onEdit,
}) => {
    ...
    useEffect(() => {
        ...
        if (temp === 330 && localStorage.getItem("testQuestion") === "347") {
            categoryId = "225";
        }

        if (temp === 336 && localStorage.getItem("testQuestion") === "348") {
            categoryId = "228";
        }
